...
function homeTeamName() {
  ...
  function numPointsScored(playerName) {
    ...
    const playerStats = gameData.home.players[playerName] || gameData.away.players[playerName];
  ...
  function playerNumbers(teamName) {
    const teamPlayers =
      gameData.home.teamName === teamName ? gameData.home.players : gameData.away.players;
  ...
  function bigShoeRebounds() {
    ...
    for (const team of [gameData.home, gameData.away]) {
